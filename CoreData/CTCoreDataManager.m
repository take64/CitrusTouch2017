...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    if ([self coordinator] == nil)
    {
        ...
        NSError *error = nil;
        [self setCoordinator:[[NSPersistentStoreCoordinator alloc] initWithManagedObjectModel:[self managedObjectModel]]];
...
- (BOOL)saveContext
{
    ...
    {
        // 通知登録
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(managedObjectContextDidSave:) name:NSManagedObjectContextDidSaveNotification object:_context];
    }
    // 保存処理
    NSError *error;
...
{
    [[self managedObjectContextForCurrentThread] rollback];
}
